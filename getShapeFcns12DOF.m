 function [shapefcn,shapefcn_ddr,shapefcn_dds,shapefcn_drds] = getShapeFcns12DOF(r, s, a)
...
shapefcn = zeros(1,12);
shapefcn_ddr = zeros(1,12);
shapefcn_dds = zeros(1,12);
shapefcn_drds = zeros(1,12);
...
shapefcn(4) = Hr_02*Hs_01;
shapefcn(5) = Hr_12*Hs_01;
shapefcn(6) = Hr_02*Hs_11;

shapefcn(7) = Hr_02*Hs_02;
shapefcn(8) = Hr_12*Hs_02;
shapefcn(9) = Hr_02*Hs_12;

shapefcn(10) = Hr_01*Hs_02;
shapefcn(11) = Hr_11*Hs_02;
shapefcn(12) = Hr_01*Hs_12;
...
shapefcn_ddr(4) = Hddr_02*Hs_01;
shapefcn_ddr(5) = Hddr_12*Hs_01;
shapefcn_ddr(6) = Hddr_02*Hs_11;

shapefcn_ddr(7) = Hddr_02*Hs_02;
shapefcn_ddr(8) = Hddr_12*Hs_02;
shapefcn_ddr(9) = Hddr_02*Hs_12;

shapefcn_ddr(10) = Hddr_01*Hs_02;
shapefcn_ddr(11) = Hddr_11*Hs_02;
shapefcn_ddr(12) = Hddr_01*Hs_12;
...
shapefcn_dds(4) = Hr_02*Hdds_01;
shapefcn_dds(5) = Hr_12*Hdds_01;
shapefcn_dds(6) = Hr_02*Hdds_11;

shapefcn_dds(7) = Hr_02*Hdds_02;
shapefcn_dds(8) = Hr_12*Hdds_02;
shapefcn_dds(9) = Hr_02*Hdds_12;

shapefcn_dds(10) = Hr_01*Hdds_02;
shapefcn_dds(11) = Hr_11*Hdds_02;
shapefcn_dds(12) = Hr_01*Hdds_12;
...
shapefcn_drds(4) = Hdr_02*Hds_01;
shapefcn_drds(5) = Hdr_12*Hds_01;
shapefcn_drds(6) = Hdr_02*Hds_11;

shapefcn_drds(7) = Hdr_02*Hds_02;
shapefcn_drds(8) = Hdr_12*Hds_02;
shapefcn_drds(9) = Hdr_02*Hds_12;

shapefcn_drds(10) = Hdr_01*Hds_02;
shapefcn_drds(11) = Hdr_11*Hds_02;
shapefcn_drds(12) = Hdr_01*Hds_12;
